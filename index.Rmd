...
```
<br>
This map visualize the severity of black-to-white incarceration ratio, which indicates how many blacks are incarcerated for every one white incarcerated, 
and is important in examining racism across states. **New Jersey**, **Maryland**, **Louisiana**, **New York**, **Mississippi**, and **Illinois** appear to 
have a higher rate (light red), while the majority of the states show a low rate (dark red to black). This indicates a possibility that black
people commit more crimes in those states but on the other hand, a potential higher racial disparity.
